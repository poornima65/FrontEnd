...
<tr>
      ...
      <td>
       ...
       <a href="<c:url value='/admin/Supplier/update/${sup.supId}'/> " class="btn btn-info btn-sm">
          <span class="glyphicon glyphicon-pencil"></span> Edit
        </a>
        
   <td>
     
     <a href="<c:url value='/admin/Supplier/delete/${sup.supId}' />" class="btn btn-info btn-sm">
