...
<tr>
      ...
      <td>
       ...
       <a href="<c:url value='/admin/Category/update/${cat.catId}'/> " class="btn btn-info btn-sm">
   ...
   <td>
     ...
     <a href="<c:url value='/admin/Category/delete/${cat.catId}' />" class="btn btn-info btn-sm">
